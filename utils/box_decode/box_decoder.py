...
from utils.box_decode.cbox_decode import cbox_decode
...
class BoxDecoderPytorch(BoxDecoderBase):
    ...
    def _check_version(self, current='0.0.0', minimum='0.0.0', name='version ', pinned=False, hard=False, verbose=False):
    ...
    def _make_grid(self, nx=20, ny=20, i=0):
        ...
        if self._check_version(torch.__version__, '1.10.0'):  # torch>=1.10.0 meshgrid workaround for torch>=0.7 compatibility
